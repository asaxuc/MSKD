...
class VocDataset(Dataset):
    ...
    def __init__(self, args, img_prefix, ann_file, class_name, img_size=224, train_mode=False):
        ...
        self.img_ids = open(self.ann_file,"r").read().splitlines()
        ...
        self.use_paloty = (args.udec == 'ddgsd' and train_mode )
